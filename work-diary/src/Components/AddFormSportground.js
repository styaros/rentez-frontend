...
import { createSportground, getAllSportgroundTypes } from "../Api/SportgroundApi";
...
const AddFormSportground = ({ fetchData, id }) => {
    dayjs.extend(utc);
    ...
    const [sportgrounds, setSportgrounds] = useState({
        address: '',
        description: '',
        workStartTime: dayjs.utc().local(),
        workEndTime: dayjs.utc().local(),
        sportgroundTypeId: ''
    });
    ...
    const handleSave = async () => {
        ...
        await createSportground(parseInt(id),{
            ...sportgrounds,
            workStartTime: formattedDatesStartToSend,
            workEndTime: formattedDatesEndToSend,
            sportgroundTypeId: typeId,
...
export default AddFormSportground;
